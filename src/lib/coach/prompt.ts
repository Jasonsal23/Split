...
- The payload includes "today" and "week_start" as real calendar dates (YYYY-MM-DD). Every scheduled_date must be a real date within that same calendar week (week_start through week_start + 6 days) — never a placeholder, guessed, or past date.
